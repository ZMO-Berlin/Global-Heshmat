...
const artwork: Artwork = {
	...
	images: [{src: "transport_BTM_Statue from workshop in Ain Shams.jpg",
		...
		{ 		src: "Heshmat_Inauguration_BTM.jpeg",
         		caption: "Inauguration at BTM"},
	   {	src: "BTM Figur Eröffnung 1993_palmenwedel Kopie_Family archive.HEIC",
     	   caption: "Launch of the Statue in 1993"},
		   {	src: "BTM Statue_männl. Seite_ganz Kopie_A_Kamel.jpg",
     	   caption: "Photo: Ahmed Kamel, 2025"},
		   {	src: "BTM Statue_männl. Seite_Torso Kopie_A_Kamel.jpg",
     	   caption: "Photo: Ahmed Kamel, 2025"},
