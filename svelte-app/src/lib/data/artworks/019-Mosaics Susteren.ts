...
const artwork: Artwork = {
	...
	images: [{src: "Küssende_Schwimmbad.jpg"},
	   ...
	   {	src: "Rückseite_Schwimmbad.jpg",
     	   caption: "Backside of a Photo: Part of a 30-square-metre ceramic panel surrounding a swimming pool in the Netherlands, 1970. By Hassan Hashmat"}
		   ]
